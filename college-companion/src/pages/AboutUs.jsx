...
const teamMembers = [
  {
    ...
    img: "/Simple.jpg",
    description:
      "Passionate about server-side architecture and API development. Specializes in building scalable backend systems.",
  ...
  },
  {
    ...
    img: "/Lum.jpg",
    description:
      "Creative frontend developer with an eye for design and user experience. Loves bringing designs to life.",
  ...
  },
  {
    ...
    img: "/Brian.jpg",
    description:
      "Detail-oriented developer focused on creating responsive and accessible web applications.",
  ...
  },
  {
    ...
    img: "/Haris.jpg",
    description:
      "Systems architect with expertise in cloud infrastructure and database optimization.",
  ...
  },
  {
    ...
    img: "/Tebo.jpg",
    description:
      "Database specialist focused on data modeling, optimization, and ensuring data integrity.",
  ...
  },
  {
    ...
    img: "/Khan.jpg",
    description:
      "Data engineer passionate about building efficient database systems and data pipelines.",
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p className="hero-description">
              We are a team of passionate second-year Software Engineering
              students from ICT University, dedicated to solving real problems
      ...
      <section className="mission-section">
        <div className="mission-content">
          ...
          <p className="mission-text">
            ...
            application by creating innovative digital tools that enhance the
            university experience. We believe in the power of technology to
            solve everyday problems and make student life more efficient and
            enjoyable.
          </p>
        </div>
      </section>
                      ...
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(
                            member.name
                          )}&background=F68712&color=fff&size=200`;
                        }}
                      />
      ...
      <section className="cta-section">
        <div className="cta-content">
          ...
          <p className="cta-description">
            We're always open to new opportunities and collaborations. Let's
